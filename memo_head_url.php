<?php
    ...
    $menu_q = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> 3333333333 </a>'; 
    $menu_a = '<a href="'.$home.'/bbs/write.php?bo_table=gnutour" target="_self"> 여행상품 추가 +  </a>';

    $menu_flight          = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> FLIGHT </a>'; 
    $menu_hotel           = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> HOTEL </a>'; 

    $menu_uscanada        = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> US / CANADA </a>';
    $menu_west            = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> WEST </a>'; 
    $menu_east            = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> EAST </a>'; 
    $menu_hawaii          = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> HAWAII </a>'; 
    $menu_canada          = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> CANADA </a>'; 

    $menu_korea           = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> KOREA </a>'; 
    $menu_asia            = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> ASIA </a>'; 
    $menu_china           = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> CHINA </a>'; 
    $menu_sasia           = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> SOUTHEAST ASIA </a>'; 
    $menu_japan           = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> JAPAN </a>'; 

    $menu_australiaeurop  = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> AUSTRALIA / EUROPE </a>'; 
    $menu_austraila       = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> AUSTRALIA </a>'; 
    $menu_europe          = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> EUROPE </a>'; 

    $menu_qa              = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> Q&A </a>'; 
    $menu_confirm         = '<a href="'.$home.'/bbs/board.php?bo_table=qna" target="_self"> CONFIRM </a>'; 
...
<header>
    ...
    <section class="topbar clearfix" style="background-color: #00BDBB; color: white;">
        <div class="inner">
            <div class="t-left col-sm-9 clearfix" style="font-size:14px;">
                <span> <i class="fa fa-map-marker"></i> <a href="https://www.google.com/maps/dir/Current+Location/3435 Wilshire blvd #103, LA CA 90010" style="font-size:14px;"> 3435 Wilshire blvd #103, LA CA 90010 </a>  </span>
                <span> <i class="fa fa-envelope"></i> <a href="mailto:star@tourstarusa.com" style="font-size:14px;"> help@memoatour.com </a></span>
                <span> <i class="fa fa-phone"></i><a href="tel:213-381-8000" style="font-size:14px;">+1 213-381-8000</a></span>
            </div><!--end:t-left-->
    ...
    <div class="nav-container stickmenu3333333-on-off-33333 clearfix" style="padding: 10px;">
        <div class="inner">
            ...
            <ul class="main-menu">
                <li class="multi-level-menu" style="z-index:999"> <?php echo $menu_flight; ?> </li>
                <li class="multi-level-menu" style="z-index:998"> <?php echo $menu_hotel; ?> </li>
                <li class="multi-level-menu" style="z-index:997"> <?php echo $menu_uscanada; ?> 
                    <ul class="sub-menu">
                        <li class="multi-level-menu" style="z-index:998"> <?php echo $menu_west; ?> </li>
                        <li class="multi-level-menu" style="z-index:997"> <?php echo $menu_east; ?> </li>
                        <li class="multi-level-menu" style="z-index:996"> <?php echo $menu_hawaii; ?> </li>
                        <li class="multi-level-menu" style="z-index:995"> <?php echo $menu_canada; ?> </li>
                    </ul>
                </li>
                <li class="multi-level-menu" style="z-index:996"> <?php echo $menu_korea; ?> </li>
                <li class="multi-level-menu" style="z-index:995"> <?php echo $menu_asia; ?> 
                    <ul class="sub-menu">
                        <li class="multi-level-menu" style="z-index:999"> <?php echo $menu_china; ?> </li>
                        <li class="multi-level-menu" style="z-index:998"> <?php echo $menu_sasia; ?> </li>
                        <li class="multi-level-menu" style="z-index:997"> <?php echo $menu_japan; ?> </li>
                    </ul>
                </li>
                <li class="multi-level-menu" style="z-index:995"> <?php echo $menu_australiaeurop; ?> 
                    <ul class="sub-menu">
                        <li class="multi-level-menu" style="z-index:999"> <?php echo $menu_austraila; ?> </li>
                        <li class="multi-level-menu" style="z-index:998"> <?php echo $menu_europe; ?> </li>
                    </ul>
                </li>
                <li class="multi-level-menu" style="z-index:994"> <?php echo $menu_qa; ?> </li>
                <li class="multi-level-menu" style="z-index:993"> <?php echo $menu_confirm; ?> </li>    
                <?php if ($is_admin): ?>
